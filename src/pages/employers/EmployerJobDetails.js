...
const Button = tw.button`inline-flex items-center justify-center w-full sm:w-2/3 md:w-1/3 mb-12 mx-auto p-2 bg-green-600 text-center font-bold text-white rounded-md mt-2`;
    ...
    return (
        <>
            ...
            <Container>
                ...
                <Button onClick={() => history.goBack()}><FiArrowLeftCircle size={24} /> &nbsp; Back</Button>
