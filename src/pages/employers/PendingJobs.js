        ...
        <Container>
            ...
            <Header>
                <div tw='text-center md:text-left'>
                    <Heading>List Of Pending Applications</Heading>
                    <p tw='mt-2 text-base inline-block mb-4 md:mb-0'><span tw="text-warning font-bold">{details[0]?.user_applied.length || "N/A"}</span> | Total Application(s)</p>
                </div>
            </Header>
